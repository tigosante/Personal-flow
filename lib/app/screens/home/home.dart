...
class _HomeState extends State<Home> {
      ...
      setState(() {
        ...
        _tarefas = _cont > 0
            ? _cont == 1
                ...
                : "Você tem ${subtarefas._toDoList.length} tarefas pendentes!"
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      //       icon: Icon(Icons.playlist_add_check, color: Colors.red),
      //       activeIcon: Icon(Icons.playlist_add_check, color: Colors.white),
      //       title: Text(
      //         "Tarefas",
      ...
      //       activeIcon: Icon(Icons.poll, color: Colors.white),
      //       title: Text(
      //         "Gráfico",
      //         style: TextStyle(color: Colors.white),
      //       ),
      ...
      leftChild: Scaffold(
        body: Center(
          child: Container(
            ...
            child: Center(
              child: Text(
                  "Painel com opções de vavegação: Arquivados, configurações, lixeira(talvez)"),
            ),
          ),
        ),
      ),
      scaffold: new Scaffold(
        ...
        body: Column(
          ...
          children: <Widget>[
            ...
            Expanded(
              child: Center(child: buildCardsDetails(context)),
            ),
                        ...
                        child: Column(
                          children: <Widget>[
                            ListTile(
                              ...
                              subtitle: subtarefas
                                          ._toDoList[index]["details"].length <
                                      1
                                  ? null
                                  : (subtarefas._toDoList[index]["details"]
                                              .length ==
                                          1
                                      ? Text(
                                          "${subtarefas._toDoList[index]["details"].length} subtarefa não concluída.",
                                          style: TextStyle(
                                      ...
                                      : Text(
                                          "${subtarefas._toDoList[index]["details"].length} subtarefas não concluídas.",
                                          style: TextStyle(
                                            fontStyle: FontStyle.italic,
                                            fontWeight: FontWeight.bold,
                                            color: index % 2 == 0
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    RaisedButton(
                                      ...
                                      onPressed: () {
                                        setState(() {
                                          if (!subtarefas._toDoList[index]
                                              ["ok"]) {
                                            List<bool> antigo = [];

                                            if (!subtarefas._toDoList[index]
                                                ["ok"]) {
                                              subtarefas._toDoList[index]
                                                      ["ok"] =
                                                  !subtarefas._toDoList[index]
                                                      ["ok"];
                                            }
  ...
  Widget buildBody(BuildContext context, index) {
    return Container(
      padding: EdgeInsets.only(
        top: subtarefas._toDoList[index]["details"]["$index"] ==
                subtarefas._toDoList[index]["details"]["0"]
            ? MediaQuery.of(context).size.width * 0.03
            : 0,
        bottom: subtarefas._toDoList[index]["details"]["$index"] ==
                subtarefas._toDoList[index]["details"]["${-1}"]
            ? MediaQuery.of(context).size.width * 0.03
            : 0,
        left: subtarefas._toDoList[index]["details"]["0"]["bool"]
            ? 0
            : MediaQuery.of(context).size.width * 0.02,
        right: subtarefas._toDoList[index]["details"]["0"]["bool"]
            ? MediaQuery.of(context).size.width * 0.02
            : 0,
      ),
      child: Column(
        children: <Widget>[
              ...
              Expanded(
                child: ListTile(
                    ...
                    leading: subtarefas._toDoList[index]["details"]["0"]["bool"]
                            ...
                            onPressed: () {
                              setState(() {
                                if (subtarefas
                                        ._toDoList[index]["details"].length >
                                    1) {
                                  if (subtarefas._toDoList[index]["details"]
                                      ["0"]["bool"]) {
                                    subtarefas._toDoList[index]["details"]["0"]
                                            ["bool"] =
                                        !subtarefas._toDoList[index]["details"]
                        ...
                        : null,
                    trailing: subtarefas._toDoList[index]["details"]["0"]
                            ["bool"]
                        ? null
                        : IconButton(
                            icon: subtarefas._toDoList[index]["details"]["0"]
                                    ["bool"]
                                ? Icon(
                                    Icons.check_circle,
                                    color: Colors.transparent,
          ...
          subtarefas._toDoList[index]["details"]["$index"] ==
                  subtarefas._toDoList[index]["details"]["${-1}"]
              ? Divider(
                  height: 0,
    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          Column(
            children: List<Widget>.generate(_subtarefasSize,
                (int index) => buildDetailsBody(context, index)).toList(),
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Card(
        ...
        child: FAProgressBar(
            ...
            progressColor:
                index % 2 != 0 ? Colors.blue[300] : Colors.orange[300],
