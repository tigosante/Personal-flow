...
class Simples extends StatefulWidget {
  Simples({Key key, this.titulo, this.data, this.hora, this.agendada})
      :  super(key: key);

  String titulo;
  String data;
  String hora;
  List<dynamic> agendada;
  @override
        ...
        child: Container(
          ...
          child: ExpandablePanel(
            ...
            header   : ListTile(
              ...
              onTap: () =>
                  modal(context, _tamanhoTela, _tipo, this.widget.titulo),
            ),
            expanded: Column(
