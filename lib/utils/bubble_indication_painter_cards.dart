...
class TabIndicationPainterCards extends CustomPainter {
  Paint painter;
  ...
  TabIndicationPainterCards(
      {this.dxTarget = 141.0,
        this.dxEntry = 23.0,
        this.radius  = 20.0,
        this.dy      = 23.0,
        this.pageController}) : super(repaint: pageController) {
          painter = new Paint()
  ...
  @override
  bool shouldRepaint(TabIndicationPainterCards oldDelegate) => true;
